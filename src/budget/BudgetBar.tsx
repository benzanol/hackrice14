...
export default function BudgetBar(ps: {
  ...
  const padAboveGoal = padAboveIncome + ps.saveGoal * totalIncome;
  ...
  return (
    <div className="relative" style={{width: leftPad + pixelW + 180}}>
      ...
      <Bracket x={leftPad}
               ...
               left={true}
               label={`Spending Target: ${dollarString(totalIncome*(1 - ps.saveGoal))}`}
               labelTop
               color="#9933cc"
      />
